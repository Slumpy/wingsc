...
<div class="container">
	...
	<div id="header" class="span-24">
		<?php echo html::anchor('', html::image('media/img/wings.png', array(
			...
			'id' => 'logo'))) ?>
		<ul id="menu">
			<li class="did"><?php echo html::anchor(Route::get('work')->uri(), 'Work') ?></li>
			<li class="does"><?php echo html::anchor(Route::get('default')->uri(array('page' => 'does')), 'About') ?></li>
			<li class="will"><?php echo html::anchor(Route::get('calendar')->uri(), 'Calendar') ?></li>
			<li class="for"><?php echo html::anchor(Route::get('contact')->uri(), 'Contact') ?></li>
		</ul>
	</div>
